# Generated by Django 4.1.7 on 2023-03-14 20:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_url', models.CharField(max_length=200)),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book_event', to='bookwormapi.book')),
            ],
        ),
        migrations.CreateModel(
            name='Reader',
